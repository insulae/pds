...
<div class="cont-login-fondo">
	<div id="cont-login" class="cont-login">
		...
		<button id="btn-login" type="button" class="btn btn-danger btn-login"><label tex="ingresar"></label></button>
		<button id="btn-deslogin" type="button" class="btn btn-danger btn-login"><label tex="salir"></label></button>
...
<!--######################### MODAL AGREGAR AVION ########################## -->
  <!-- Modal -->
  <div class="modal" id="modalAltaAvion">
    <div class="modal-dialog"  style="width: 500px; top: 100px">
      <div class="modal-content">
        <div class="modal-header">
        <label tex="alta_avion"></label><button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
            ...
            <br><br>
            <button id="avion-agregar" type="button" class="btn btn-danger" style="width: 100px; height: 40px;"><label tex="agregar_avion"></label></button>
        </div>
      </div>
